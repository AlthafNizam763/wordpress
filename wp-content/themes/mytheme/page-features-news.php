...
<main class="container" style="padding: 60px 20px;">
    <div class="gallery-masonry" style="column-count: 4; column-gap: 20px;">
        <?php
        $news_path = get_template_directory() . '/images/news/';
        $news_url = get_template_directory_uri() . '/images/news/';

        // Get all image files
        $images = glob($news_path . '*.{jpg,jpeg,png,gif}', GLOB_BRACE);
        ...
        if ($images) {
            ...
            echo '<p style="text-align: center; color: #666;">No images found in the news.</p>';
        }
        ?>
    </div>
    <style>
